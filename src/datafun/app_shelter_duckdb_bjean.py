...
STORE_CSV: Final[Path] = DATA_RAW_DIR / "shelter_bjean.csv"
SALE_CSV: Final[Path] = DATA_RAW_DIR / "adoption_bjean.csv"
...
def main() -> None:
    ...
    try:
        ...
        # ----------------------------------------------------
        run_sql_script(con, SQL_DIR / "bjean_shelter_clean.sql")

        # ----------------------------------------------------
        # STEP 2: BOOTSTRAP (create tables, load CSV data)
        # ----------------------------------------------------
        run_sql_script(con, SQL_DIR / "bjean_shelter_bootstrap.sql")
        ...
        # ----------------------------------------------------
        run_sql_query(con, SQL_DIR / "bjean_shelter_query_kpi_revenue.sql")
